-- =====================================================
-- MIGRATION: UAZ INSTANCE LOGS (Histórico/Auditoria)
-- Descrição: Tabela para rastrear TODOS os eventos de cada instância
-- Data: 2024
-- =====================================================
...
COMMENT ON COLUMN uaz_instance_logs.event_type IS 'Tipos: created, connected, disconnected, deleted, updated, status_check, error';
...
-- Inserir log de criação para instâncias existentes
