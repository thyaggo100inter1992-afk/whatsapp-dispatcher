...
import {
  ...
  FaBan, FaLink, FaArrowRight, FaPlay, FaGift
} from 'react-icons/fa';
...
export default function LandingPage() {
  ...
  const loadData = async () => {
    try {
      ...
      const [plansRes, featuresRes, statsRes] = await Promise.all([
      ...
      <section id="planos" className="py-20 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto relative">
          <div className="text-center mb-12">
            ...
            <div className="inline-flex bg-dark-800/80 backdrop-blur-sm rounded-full p-1.5 border-2 border-primary-500/50 shadow-xl shadow-primary-500/30">
              <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
              {plans.map((plan, index) => {
                ...
                return (
                  <div
                    key={plan.id}
                    className={`relative bg-gradient-to-br ${colors.gradient} backdrop-blur-xl rounded-3xl p-8 border-2 ${colors.border} transition-all duration-300 hover:scale-110 hover:-translate-y-2 shadow-2xl ${colors.shadow} ${
                  ...
                  >
                    ...
                    <div className="text-center mb-6 relative">
                      <h3 className={`text-3xl font-black text-white mb-2 ${isPopular ? 'text-4xl' : ''}`}>
                        {plan.nome}
                      </h3>
                      <p className="text-white/70 text-sm mb-6">{plan.descricao}</p>
                    ...
                    <div className="space-y-3 mb-8">
                      ...
                      <div className="flex items-center gap-3 text-white bg-white/5 backdrop-blur-sm rounded-lg p-3 hover:bg-white/10 transition-all">
                        ...
                        <span className="font-semibold">{plan.limite_mensagens_dia === -1 ? '♾️ Mensagens ilimitadas' : `💬 ${plan.limite_mensagens_dia.toLocaleString()} mensagens/dia`}</span>
                      </div>
                      <div className="flex items-center gap-3 text-white bg-white/5 backdrop-blur-sm rounded-lg p-3 hover:bg-white/10 transition-all">
                        <div className="bg-gradient-to-br from-green-400 to-emerald-500 rounded-full p-1.5">
                          <FaCheckCircle className="text-white text-sm" />
                        </div>
                        <span className="font-semibold">{plan.limite_campanhas_mes === -1 ? '♾️ Campanhas ilimitadas' : `🚀 ${plan.limite_campanhas_mes} campanhas/mês`}</span>
                      </div>
                      
                      {plan.funcionalidades?.whatsapp_api && (
                        <div className="flex items-center gap-3 text-white bg-white/5 backdrop-blur-sm rounded-lg p-3 hover:bg-white/10 transition-all">
                          <div className="bg-gradient-to-br from-green-400 to-emerald-500 rounded-full p-1.5">
                            <FaCheckCircle className="text-white text-sm" />
                          </div>
                      ...
                      {plan.funcionalidades?.whatsapp_qr && (
                        <div className="flex items-center gap-3 text-white bg-white/5 backdrop-blur-sm rounded-lg p-3 hover:bg-white/10 transition-all">
                          <div className="bg-gradient-to-br from-green-400 to-emerald-500 rounded-full p-1.5">
                            <FaCheckCircle className="text-white text-sm" />
                          </div>
                    ...
                    <button
                      onClick={() => router.push('/registro')}
                      className={`relative w-full py-4 rounded-xl font-black text-lg transition-all duration-300 flex items-center justify-center gap-3 overflow-hidden group ${
                        isPopular
